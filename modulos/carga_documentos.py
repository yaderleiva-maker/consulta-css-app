        ...
        if st.button("🚀 Cargar datos", type="primary"):
            ...
            try:
                ...
                if df_clientes.empty:
                    st.error("❌ No hay cédulas válidas")
                ...
                for _, row in df_clientes.iterrows():
                    ...
                    if cedula in mapa_cedula_a_id:
                        ...
                        clientes_actualizar.append({
                            ...
                            "fecha_nac": row.get('fecha_nac', None) or None,
                ...
                if clientes_actualizar:
                    for c in clientes_actualizar:
                        ...
                        SET nombre = '{c['nombre'].replace("'", "''")}',
                            genero = '{c['genero']}',
                            fecha_nac = {f"DATE('{c['fecha_nac']}')" if c['fecha_nac'] else 'NULL'},
                ...
                if df.empty:
                    st.warning("⚠️ No hay clientes válidos")
                else:
                    # =====================
                    # TELÉFONOS
                    # =====================
